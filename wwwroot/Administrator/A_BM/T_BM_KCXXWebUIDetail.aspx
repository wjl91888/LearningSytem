<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="T_BM_KCXXWebUIDetail.aspx.cs" Inherits="T_BM_KCXXWebUIDetail" %>
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">课程信息详情</asp:Content>
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <%# DataBinder.Eval(Container.DataItem, "KCXLBH_T_BM_KCXLXX_KCXLMC") + Convert.ToChar(38).ToString() +"nbsp;"%>
                                            ...
                                            <div id = "KCTP" runat = "server" >
                                        
                               <%# DataBinder.Eval(Container.DataItem, "KCTP") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?a=d"+ AndChar +"file=" + HttpUtility.UrlEncode((string)DataBinder.Eval(Container.DataItem, "KCTP")) + "' target='_blank'>下载</a>"%>
                               <%# DataBinder.Eval(Container.DataItem, "KCTP") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?file=" + HttpUtility.UrlEncode((string)DataBinder.Eval(Container.DataItem, "KCTP")) + "' target='_blank'>预览</a>"%>
                                                
                                           </div>
                                      
                                            <div id = "KCNR" runat = "server" >
                                        
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCNR"), null) + Convert.ToChar(38).ToString() +"nbsp;"%>
                                                
                                           </div>
                                      
                                            <div id = "KCKKSJ" runat = "server" >
