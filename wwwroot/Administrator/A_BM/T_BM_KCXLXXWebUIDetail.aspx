<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="T_BM_KCXLXXWebUIDetail.aspx.cs" Inherits="T_BM_KCXLXXWebUIDetail" %>
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">课程系列信息详情</asp:Content>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div id="divvaluearea" runat="server" style = "display:none;">
                                            ...
                                            <div id = "KCXLBH" runat = "server" >
                                        
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCXLBH"), null) + Convert.ToChar(38).ToString() +"nbsp;"%>
                                                
                                           </div>
                                      
                                            <div id = "KCXLMC" runat = "server" >
                                        
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCXLMC"), null) + Convert.ToChar(38).ToString() +"nbsp;"%>
                                                
                                           </div>
                                      
                                            <div id = "KCXLSJBH" runat = "server" >
                                        
                                    <%# DataBinder.Eval(Container.DataItem, "KCXLSJBH_T_BM_KCXLXX_KCXLMC") + Convert.ToChar(38).ToString() +"nbsp;"%>
                                        
                                           </div>
                                      
                                            <div id = "KCXLTP" runat = "server" >
                                        
                               <%# DataBinder.Eval(Container.DataItem, "KCXLTP") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?a=d"+ AndChar +"file=" + HttpUtility.UrlEncode((string)DataBinder.Eval(Container.DataItem, "KCXLTP")) + "' target='_blank'>下载</a>"%>
                               <%# DataBinder.Eval(Container.DataItem, "KCXLTP") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?file=" + HttpUtility.UrlEncode((string)DataBinder.Eval(Container.DataItem, "KCXLTP")) + "' target='_blank'>预览</a>"%>
                                                
                                           </div>
                                      
                                            <div id = "KCXLJJ" runat = "server" >
                                        
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCXLJJ"), null) + Convert.ToChar(38).ToString() +"nbsp;"%>
                                                
                                           </div>
                                      
                                            <div id = "NLD" runat = "server" >
                                        
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "NLD"), null) + Convert.ToChar(38).ToString() +"nbsp;"%>
                                                
                                           </div>
                                      
                                            <div id = "KSS" runat = "server" >
