    ...
    public class T_BM_KCXLXXWebUIBase : WebUIBase
    {
        ...
        protected virtual void AddRecord()
        {
            if (GetAddInputParameter())
            {
                ...
                {
                    MessageContent = MessageManager.GetMessageInfo(MessageManager.HINT_MSGID_0015, new string[] {"课程系列信息", "添加"}, strMessageInfo);
                    string strLogContent = MessageManager.GetMessageInfo(MessageManager.LOG_MSGID_0003, new string[] {(string)Session[ConstantsManager.SESSION_USER_LOGIN_NAME], "课程系列信息", appData.KCXLMC.ToString(), "添加"});
                    LogLibrary.LogWrite("A02", strLogContent, null, null, null);
                    Page.CloseWindow(true);
                }
                else
                {
                    MessageContent = MessageManager.GetMessageInfo(MessageManager.ERR_MSGID_0013, new string[] {"此编号", "课程系列信息"}, strMessageInfo);
        ...
        protected virtual void ModifyRecord()
        {
            if (GetModifyInputParameter())
            {
                ...
                MessageContent = MessageManager.GetMessageInfo(MessageManager.HINT_MSGID_0015, new string[] {"课程系列信息", "修改"}, strMessageInfo);
                string strLogContent = MessageManager.GetMessageInfo(MessageManager.LOG_MSGID_0003, new string[] {(string)Session[ConstantsManager.SESSION_USER_LOGIN_NAME], "课程系列信息", appData.KCXLMC.ToString(), "修改"});
                LogLibrary.LogWrite("A02", strLogContent, null, null, null);
                Page.CloseWindow(true);
            }
        }
        ...
        protected virtual void DeleteRecord()
        {
            if (GetDeleteInputParameter())
            {
                ...
                string strLogContent = MessageManager.GetMessageInfo(MessageManager.LOG_MSGID_0003, new string[] {(string)Session[ConstantsManager.SESSION_USER_LOGIN_NAME], "课程系列信息", (string)appData.ObjectIDBatch, "删除"});
                LogLibrary.LogWrite("A02", strLogContent, null, null, null);
            }
            else
            {
        ...
        protected virtual ValidateData ValidateKCXLBH(object objValidateData, bool boolNullable, bool boolExist)
        {
            ...
            try
            {
                ...
                validateData.Nullable = boolNullable;
                validateData.Exist = boolExist;
                validateData.Parameters[0] = "课程系列编号";
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"课程系列编号已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"课程系列编号不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
        ...
        protected virtual ValidateData ValidateKCXLMC(object objValidateData, bool boolNullable, bool boolExist)
        {
            ...
            try
            {
                ...
                validateData.Nullable = boolNullable;
                validateData.Exist = boolExist;
                validateData.Parameters[0] = "课程系列名称";
                validateData.Parameters[1] = "1";
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"课程系列名称已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"课程系列名称不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
        ...
        protected virtual ValidateData ValidateKCXLSJBH(object objValidateData, bool boolNullable, bool boolExist)
        {
            ...
            try
            {
                ...
                validateData.Nullable = boolNullable;
                validateData.Exist = boolExist;
                validateData.Parameters[0] = "所属类别";
                validateData.Parameters[1] = "1";
                validateData.Parameters[2] = "10";
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"所属类别已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"所属类别不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
        ...
        protected virtual ValidateData ValidateKCXLTP(object objValidateData, bool boolNullable, bool boolExist)
        {
            ...
            try
            {
                ...
                validateData.Nullable = boolNullable;
                validateData.Exist = boolExist;
                validateData.Parameters[0] = "系列图片";
                validateData.Parameters[1] = "1";
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"系列图片已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"系列图片不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
        ...
        protected virtual ValidateData ValidateKCXLJJ(object objValidateData, bool boolNullable, bool boolExist)
        {
            ...
            try
            {
                ...
                validateData.Nullable = boolNullable;
                validateData.Exist = boolExist;
                validateData.Parameters[0] = "课程系列简介";
                validateData.Parameters[1] = "null";
                validateData.Parameters[2] = "null";
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"课程系列简介已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"课程系列简介不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            ...
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"年龄段已存在，请再换一个。";
                                 validateData.Result = false;
                            }
                            else
                            {
                                validateData.Message = @"年龄段不存在，可以使用。";
                                validateData.Result = true;
                            }
                        }
                        else
