<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" validateRequest="false" AutoEventWireup="true" CodeFile="T_BM_KCBXXWebUISearch.aspx.cs" Inherits="T_BM_KCBXXWebUISearch" %>
...
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">课程表查询</asp:Content>
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    function RefreshGrid() {
        $find("<%= ramT_BM_KCBXX.ClientID %>").ajaxRequest("Refresh");
    }
    ...
    <telerik:RadAjaxManager ID="ramT_BM_KCBXX" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnOperate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="SearchPageTopToolBar" LoadingPanelID="ralpT_BM_KCBXX" />
                    <telerik:AjaxUpdatedControl ControlID="ListControl" LoadingPanelID="ralpT_BM_KCBXX" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="ramT_BM_KCBXX">
                <UpdatedControls>
            ...
            <div id="advancesearchpage" runat="server" class="advancesearchpage">
                ...
                <div class="main">
                    <div class="block">
                       ...
                       <div class="content" id="KCBH_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:DropDownList ID="KCBH" runat="server" CssClass="input needrefresh"></asp:DropDownList>
                                        
                           </div>
                       </div>
  
                       <div class="content clearboth" id="KCSJ_Area" runat="server">
                           <div class="field">
                               <div class="fieldname">
                                            上课时间
                               </div>
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:TextBox ID="KCSJ" runat="server" CssClass="input needrefresh" Visible = "False"></asp:TextBox>
                             </div><div class="fieldinput width100per alignright"><B>>=</B><asp:TextBox ID="KCSJBegin" runat="server" CssClass="input needrefresh" Width = "96"></asp:TextBox><br/><B><=</B><asp:TextBox ID="KCSJEnd" runat="server" CssClass="input needrefresh" Width = "96"></asp:TextBox>
                       ...
                       <div class="content" id="SKJS_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:DropDownList ID="SKJS" runat="server" CssClass="input needrefresh"></asp:DropDownList>
                       ...
                       <div class="content" id="SKFJ_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:TextBox ID="SKFJ" runat="server" CssClass="input needrefresh"></asp:TextBox>
                   ...
                   <div ID="chkShowKCBH_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowKCBH" runat="server"  CssClass="needrefresh" Text = "课程" 
                                         Checked="true" />
                   ...
                   <div ID="chkShowKCSJ_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowKCSJ" runat="server"  CssClass="needrefresh" Text = "上课时间" 
                                         Checked="true" />
                               <asp:TextBox ID="txtKCSJColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                   ...
                   <div ID="chkShowSKJS_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSKJS" runat="server"  CssClass="needrefresh" Text = "教师" 
                                         Checked="true" />
                               <asp:TextBox ID="txtSKJSColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowSKFJ_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSKFJ" runat="server"  CssClass="needrefresh" Text = "教室" 
                                         Checked="true" />
                               <asp:TextBox ID="txtSKFJColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                   ...
                   <div ID="chkShowKCBBH_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowKCBBH" runat="server"  CssClass="needrefresh" Text = "编号" 
                                         Checked="true" />
                    ...
                    <div class="list" id="divList" runat="server">
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href="#" style="cursor:pointer;text-decoration:none;" onclick="OpenWindow('T_BM_KCXXWebUIDetail.aspx?KCBH=<%# DataBinder.Eval(Container.DataItem, "KCBH") %>',770,600,window);"><%# DataBinder.Eval(Container.DataItem, "KCBH_T_BM_KCXX_KCMC")%></a>
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href="#" style="cursor:pointer;text-decoration:none;" onclick="OpenWindow('T_PM_UserInfoWebUIDetail.aspx?UserID=<%# DataBinder.Eval(Container.DataItem, "SKJS") %>',770,600,window);"><%# DataBinder.Eval(Container.DataItem, "SKJS_T_PM_UserInfo_UserNickName")%></a>
                    ...
                    <div class="print" id="divPrint" runat="server">
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCBBH"), null)+ Convert.ToChar(38).ToString() +"nbsp;"%>
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%# DataBinder.Eval(Container.DataItem, "KCBH_T_BM_KCXX_KCMC") + Convert.ToChar(38).ToString() +"nbsp;"%>
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "KCSJ"), "yy-MM-dd hh:mm")+ Convert.ToChar(38).ToString() +"nbsp;"%>
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%# DataBinder.Eval(Container.DataItem, "SKJS_T_PM_UserInfo_UserNickName") + Convert.ToChar(38).ToString() +"nbsp;"%>
                        ...
                        Visible = "true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%# GetValue(DataBinder.Eval(Container.DataItem, "SKFJ"), null)+ Convert.ToChar(38).ToString() +"nbsp;"%>
